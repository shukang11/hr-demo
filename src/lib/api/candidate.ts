 ...
 * @param params 分页参数
 */
export async function getCandidateList(companyId: number, params: PageParams): Promise<PageResult<Candidate>> {
 ...
 * @param params 分页参数
 */
export function useCandidateList(companyId: number | undefined, params: PageParams) {
    return useSWR(
