...
class PositionService:
    ...
    def create_position(
        ...
        try:
            ...
            raise ValueError("Position creation failed - possible duplicate title or invalid department")
    ...
    def update_position(
        ...
        try:
            ...
            self.session.rollback()
            raise ValueError("Position update failed - possible duplicate title or invalid department")
